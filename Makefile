...
ifeq ($(filter $(TARGET_STRING), sm64.jp.f3d_old),)
  COMPARE := 0
endif
...
#
# Asset extraction has been temporarily disabled. This will be re-enabled
# sometime down the line, but as of now, it's easiest to skip this step and
...
$(BUILD_DIR)/text/%/define_text.inc.c: text/define_text.inc.c text/%/dialogs.h
